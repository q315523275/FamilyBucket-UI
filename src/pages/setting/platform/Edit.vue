<template>
  <el-dialog :title="btnName" :visible.sync="show" :close-on-click-modal="false" width="50%">
    <el-form :model="modelForm" :rules="rules" ref="modelForm" label-width="120px" v-if="modelForm"
      ...
      <el-form-item label="平台Key" prop="Key">
        <el-input v-model="modelForm.Key"></el-input>
      </el-form-item>
      <el-form-item label="平台负责人" prop="Author">
        <el-input v-model="modelForm.Author"></el-input>
      </el-form-item>
      <el-form-item label="平台开发者" prop="Developer">
        <el-input v-model="modelForm.Developer"></el-input>
      </el-form-item>
      ...
      <el-form-item label="是否删除" prop="IsDel">
        <el-switch v-model="modelForm.IsDel"></el-switch>
      </el-form-item>
      <el-form-item>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        Key: [
          { required: true, message: '请输入平台Key', trigger: 'blur' }
        ]
      }
    }
  },
