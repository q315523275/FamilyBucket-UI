    ...
    <el-form :model="modelForm" :rules="rules" ref="modelForm" label-width="120px" v-if="modelForm"
      ...
      <el-form-item label="组件名称" prop="CommandType">
        <el-select v-model='modelForm.CommandType' placeholder='请选择'>
          ...
          <el-option key='CommandType_1' label='授权认证' value='Bucket.Authorize'></el-option>
          <el-option key='CommandType_2' label='错误码组件' value='Bucket.ErrorCode'></el-option>
          <el-option key='CommandType_3' label='Token黑名单' value='Bucket.BlackJwt'></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="命令" prop="CommandText">
        <el-select v-model='modelForm.CommandText' placeholder='请选择'>
          <el-option key='CommandText_0' label='更新' value='Refresh'></el-option>
          <el-option key='CommandText_1' label='重载' value='Reload'></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
